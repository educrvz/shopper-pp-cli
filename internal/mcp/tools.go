...
import (
	...
	"shopper-pp-cli/internal/learn"
	"shopper-pp-cli/internal/mcp/bound"
...
func handleContext(_ context.Context, _ mcplib.CallToolRequest) (*mcplib.CallToolResult, error) {
	...
	ctx := map[string]any{
		...
		"command_mirror_capabilities": []map[string]string{
			...
			{"name": "Payment Method Explorer", "command": "payment methods", "description": "Reports live card, boleto, and PIX availability plus store-specific minimum lead times.", "rationale": "Uses live /features/stores parameters so an agent does not assume that a recurring saved card, boleto, or PIX is available for a one-time purchase.", "via": "mcp-command-mirror"},
			{"name": "Payment-Aware Checkout Preparation", "command": "checkout prepare", "description": "Validates a selected payment method and basket readiness before handing final order confirmation to Shopper's browser.", "rationale": "Combines live payment capabilities and cart minimums while preserving Shopper's Django session and CSRF boundary for card, PIX, boleto, and final order confirmation.", "via": "mcp-command-mirror"},
		},
